...
- [isomorphy] &mdash; Removed in [v1.53.0], all its constituents are now
...
[v1.36.0]: https://github.com/birdofpreyru/react-utils/releases/tag/v1.36.0
[v1.39.0]: https://github.com/birdofpreyru/react-utils/releases/tag/v1.39.0
[v1.47.0]: https://github.com/birdofpreyru/react-utils/releases/tag/v1.47.0
[v1.48.0]: https://github.com/birdofpreyru/react-utils/releases/tag/v1.48.0
